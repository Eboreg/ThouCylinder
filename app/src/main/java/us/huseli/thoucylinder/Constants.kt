...
object Constants {
    ...
    const val LASTFM_AUTH_URL = "https://www.last.fm/api/auth/?api_key=${BuildConfig.lastFmApiKey}&cb=klaatu://thoucylinder/lastfm/auth"
    ...
    const val PREF_MUSIC_DOWNLOAD_URI = "musicDownloadUri"
    const val PREF_MUSIC_IMPORT_URI = "musicImportUri"
