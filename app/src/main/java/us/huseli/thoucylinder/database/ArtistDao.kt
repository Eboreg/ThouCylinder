...
interface ArtistDao {
    @Query(
        ...
        SELECT
            ...
            a3.Album_albumArt_localFile AS firstAlbumArt,
        ...
        FROM Track t
            ...
            LEFT JOIN Album a3 ON a3.Album_albumId = Track_albumId AND a3.Album_albumArt_localFile IS NOT NULL AND a3.Album_isInLibrary = 1
